...
public:
    ...
    // things added by Dylan are FillTheta, FillThetaPair
        ...
        Bool_t FillEnergy(const GTreeParticle& tree, Int_t particle_index, TH1* Eprompt, TH1* Erandom);
        Bool_t FillEnergyPair(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, TH1* Eprompt, TH1* Erandom);
