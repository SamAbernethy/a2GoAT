...
public:
    ...
    // things added by Dylan are FillTheta, FillThetaPair
        Bool_t	FillTheta(const GTreeParticle& tree,Int_t particle_index, TH1* Tprompt, TH1* Trandom, TH1* Eprompt, TH1* Erandom);
        Bool_t  FillThetaPair(const GTreeParticle& tree,Int_t particle_index, Int_t tagger_index,TH1* Tprompt, TH1* Trandom);
        Bool_t FillEnergy(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, TH1* Eprompt, TH1* Erandom);
